        ...
        <header class="topbar">
            ...
            <c:if test="${sessionScope.loggedInUser.admin}">
                <div class="topbar-actions">
                    <span class="topbar-badge">⚠️ ${pendingCount} Pending</span>
                </div>
            </c:if>
        </header>
                                                ...
                                                <c:if test="${fine.fineStatus == 'PENDING'}">
                                                    <div class="td-actions">
                                                        <form action="${pageContext.request.contextPath}/fines"
                                                            ...
                                                            <button type="submit" class="btn btn-accent btn-sm">✅ Mark Paid</button>
                                                        </form>
                                                        <form action="${pageContext.request.contextPath}/fines"
                                                              method="post" style="display:inline;"
                                                            ...
                                                            <button type="submit" class="btn btn-ghost btn-sm">🔄 Waive</button>
                                                        </form>
                                                    </div>
                                                </c:if>
                                                <c:if test="${fine.fineStatus != 'PENDING'}">

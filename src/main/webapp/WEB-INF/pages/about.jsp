...
<head>
    ...
    <style>
        .about-hero { background: linear-gradient(135deg, var(--clr-primary), var(--clr-primary-dark)); color: white; padding: 80px 20px; text-align: center; }
        .about-section { max-width: 900px; margin: 60px auto; padding: 0 20px; line-height: 1.8; color: var(--clr-text-secondary); }
        .about-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; margin-top: 40px; }
        .feature-box { padding: 30px; background: #fff; border-radius: var(--radius-lg); border: 1px solid var(--clr-border-light); text-align: center; }
        .feature-box i { font-size: 2.5rem; color: var(--clr-primary); margin-bottom: 20px; }
    </style>
</head>
<body>
    ...
    <div class="about-section">
        ...
        <div class="about-grid">
            <div class="feature-box">
                ...
                <h3>Eco-Friendly</h3>
                <p>Reducing campus emissions by encouraging bicycle use for short trips.</p>
            </div>
            <div class="feature-box">

            ...
            <div class="auth-page">
                ...
                <div class="auth-panel-left">
                    ...
                    <div class="auth-panel-hero">
                        <span class="auth-hero-emoji"><i class="fa-solid fa-person-biking auth-hero-icon"
                                style="font-size:4.5rem; color: #fff; margin-bottom: 24px; display: block;"></i></span>
                ...
                <div class="auth-panel-right">
                    ...
                    <form action="${pageContext.request.contextPath}/login" method="post" autocomplete="on">
                        ...
                        <div class="auth-options">
                            <label class="form-check">
                                <input type="checkbox" name="rememberMe" id="rememberMe" ${not empty rememberMeEmail
                                    ? 'checked' : '' }> Remember me
                            </label>
                    ...
                    <div style="margin-top: 24px; text-align: center; font-size: 0.82rem;">
                        <a href="${pageContext.request.contextPath}/about"
                            style="color: var(--clr-text-light); text-decoration: underline;">About Us</a>
                        &nbsp;|&nbsp;
                        <a href="${pageContext.request.contextPath}/terms"
                            style="color: var(--clr-text-light); text-decoration: underline;">Terms &amp; Conditions</a>
                        &nbsp;|&nbsp;
                        <a href="${pageContext.request.contextPath}/privacy"
                            style="color: var(--clr-text-light); text-decoration: underline;">Privacy Policy</a>
                    </div>
